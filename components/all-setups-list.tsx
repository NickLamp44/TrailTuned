...
import { Settings, Edit, Trash2, Bike } from "lucide-react";
...
interface AllSetupsListProps {
  setups: Setup[];
}

export function AllSetupsList({ setups }: AllSetupsListProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-2xl font-bold">All Suspension Setups</h3>
        <p className="text-sm text-muted-foreground">
          All setups across your bikes
        </p>
      </div>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2">
                    <Link
                      href={`/dashboard/bikes/${setup.bike_id}/setups/${setup.id}/edit`}
                    >
